...
def main(job_id, data_path):
  ...
  hvg_name = f"data/data_features_{data_name}_{method_proc.at[method_name,'proc']}_1_{rep}.csv"
  svg_name = f"data/data_features_{data_name}_{method_proc.at[method_name,'proc']}_2_{rep}.csv"
