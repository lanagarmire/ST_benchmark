...
file1 = f"{save_path}/results/SG/{data_name}_SG_bin_{method_proc.at[method_name,'proc']}.csv" 
file2 = f"{save_path}/results/HVG/{data_name}_HVG_{method_proc.at[method_name,'proc']}.csv" 
...
if ndims==0:
  ndims_f = f"{save_path}/results/scVI/{data_name}_scVI_hyperparams.csv"
...
for sd in seed_list:
  ...
  #### save output ### change
  outfile = f"{save_path}/results/{method_name}/{data_name}_{method_name}_dim_{bottleneck_nodes}_bin_{sd}.hdf5"    ##change
  ent.save(outfile)
