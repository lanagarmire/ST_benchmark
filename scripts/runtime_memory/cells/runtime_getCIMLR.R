...
####### load HVG
hvg_data = read.csv(fs::path("data", paste("data_cells", fname_attach, proc, 1, rep, sep = "_"), ext = "csv"), row.names = 1)

####### load SG
svg_data = read.csv(fs::path("data", paste("data_cells", fname_attach, proc, 2, rep, sep = "_"), ext = "csv"), row.names = 1)
