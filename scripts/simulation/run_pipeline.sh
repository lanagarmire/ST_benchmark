...
job_num8_2=$(sbatch --parsable --dependency=afterok:$job_num1 sim_getCIMLR.sbat)
job_num9=$(sbatch --parsable --dependency=afterok:$job_num2:$job_num3:$job_num4:$job_num5:$job_num6 sim_clus_bin_ground_truth.sbat)
job_num10=$(sbatch --parsable --dependency=afterany:$job_num7:$job_num8:$job_num8_2:$job_num9 sim_clus_bin_ground_truth_metrics_all.sbat)
